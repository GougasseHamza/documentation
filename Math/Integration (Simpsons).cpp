/*
 * Problem it Solves: Adaptive Simpson's Rule for Numerical Integration.
 * Usage: integrate(l, r).
 * Input/Output: range -> area.
 * Time Complexity: Adaptive recursion.
 * Tweaks: eps, f(x).
 * Other Use Cases: General integration.
 * Warnings: Stack depth.
 */
