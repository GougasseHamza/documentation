/*
 * Problem it Solves: Finds Pisano Period (period of Fibonacci sequence modulo n).
 * Usage: pisano_period(n) returns period length.
 * Input/Output: n (long long) -> period (long long).
 * Time Complexity: Depends on factorization of n and p-1.
 * Tweaks: Uses Pollard Rho for factorization.
 * Other Use Cases: Fibonacci modulo n properties.
 * Warnings: Heavy computation for large factors.
 */
