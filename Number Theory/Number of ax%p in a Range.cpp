/*
 * Problem it Solves: Counts integers x in [0, n] such that l <= (ax % m) <= r.
 * Usage: mod_count_range(a, m, l, r, nlo, nhi).
 * Input/Output: a, m, l, r, nlo, nhi (long long) -> count (long long).
 * Time Complexity: O(log m).
 * Tweaks: Relies on `lattice_cnt`.
 * Other Use Cases: Counting arithmetic progression terms in a range modulo m.
 * Warnings: a, m must be positive.
 */
