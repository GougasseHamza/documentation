/*
 * Problem it Solves: Computes Stirling Numbers of the First Kind S1(n, i) for fixed n and all 0 <= i <= n.
 * Usage: stirling(n) returns vector of coefficients.
 * Input/Output: n (integer) -> vector of values.
 * Time Complexity: O(n log n).
 * Tweaks: Uses divide and conquer with NTT.
 * Other Use Cases: Polynomial coefficients of x(x+1)...(x+n-1).
 * Warnings: MOD must be NTT-friendly (998244353).
 */
