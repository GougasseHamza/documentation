/*
 * Problem it Solves: Computes sums of arithmetic progressions modulo m and divided by m.
 * Usage: mod_sum(a, d, m, n), floor_sum(a, d, m, n).
 * Input/Output: a, d, m, n (long long) -> sum (long long).
 * Time Complexity: O(log m).
 * Tweaks: Standard Euclidean-like recurrence.
 * Other Use Cases: Lattice point counting.
 * Warnings: m > 0.
 */
