/*
 * Problem it Solves: Counts number of distinct values of a^k % n for all a.
 * Usage: yo(k, n) returns the count.
 * Input/Output: k, n (long long) -> count (long long).
 * Time Complexity: O(sqrt(n)).
 * Tweaks: Can be optimized with Pollard Rho.
 * Other Use Cases: Number theory problems involving powers.
 * Warnings: k=0, n=1 edge cases.
 */
