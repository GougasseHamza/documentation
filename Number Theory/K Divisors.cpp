/*
 * Problem it Solves: Counts numbers <= n with exactly k divisors.
 * Usage: backtrack(n, k) returns the count.
 * Input/Output: n (long long), k (int) -> count (long long).
 * Time Complexity: Complex, relies on Lehmer's algorithm and backtracking.
 * Tweaks: MAXN, PHI_N, PHI_K control memory/speed of sieve/precalc.
 * Other Use Cases: Counting numbers with prime factor constraints.
 * Warnings: Memory intensive.
 */
