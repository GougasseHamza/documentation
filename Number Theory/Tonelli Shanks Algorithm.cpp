/*
 * Problem it Solves: Tonelli-Shanks Algorithm to find square root modulo p.
 * Usage: SQRT(a, p) returns x such that x^2 = a (mod p).
 * Input/Output: a, p (int) -> x (int) or -1.
 * Time Complexity: O(log^2 p) worst case.
 * Tweaks: p must be prime.
 * Other Use Cases: Solving quadratic congruences.
 * Warnings: Returns -1 if no solution.
 */
