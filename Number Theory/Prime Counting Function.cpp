/*
 * Problem it Solves: Computes Prime Counting Function pi(n) using Lehmer's algorithm.
 * Usage: pcf::Lehmer(n) returns count of primes <= n.
 * Input/Output: n (long long) -> count (long long).
 * Time Complexity: O(N^(2/3)).
 * Tweaks: MAXN precomputation limit.
 * Other Use Cases: Fast prime counting for N up to 1e12+.
 * Warnings: Large memory usage for precomputed tables.
 */
