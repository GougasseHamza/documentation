/*
 * Problem it Solves: Computes sum of floor((a + d*i) / m) for i in [0, n-1].
 * Usage: floor_sum(a, d, m, n).
 * Input/Output: a, d, m, n (long long) -> sum (long long).
 * Time Complexity: O(log m).
 * Tweaks: mod_sum computes sum of ((a + d*i) % m).
 * Other Use Cases: Counting lattice points under a line.
 * Warnings: Arguments must be non-negative.
 */
