/*
 * Problem it Solves: Computes sum_{i=1}^n sigma0(i) in O(n^(1/3)).
 * Usage: sum_sigma0(n).
 * Input/Output: n (uint64) -> sum (uint128).
 * Time Complexity: O(n^(1/3)).
 * Tweaks: Uses geometric cut optimization.
 * Other Use Cases: Divisor sumatory function.
 * Warnings: Uses uint128.
 */
