/*
 * Problem it Solves: Smallest non-negative x such that l <= (ax mod p) <= r.
 * Usage: f(p, a, l, r) returns x.
 * Input/Output: p, a, l, r (long long) -> x (long long).
 * Time Complexity: O(log p).
 * Tweaks: Uses recursive reduction (Euclidean-like).
 * Other Use Cases: Modular arithmetic constraints.
 * Warnings: p not necessarily prime.
 */
