'''
Problem it Solves: Generates solutions to Pell's Equation x^2 - n*y^2 = 1.
Usage: Run as script. Input n.
Input/Output: n -> Pairs (x, y).
Time Complexity: O(sqrt(n) * log(val)).
Tweaks: k variable controls number of solutions.
Other Use Cases: Diophantine approximation.
Warnings: Solutions grow exponentially.
'''
...
def main():
    # Use stdin for reading input in competitive programming
    try:
